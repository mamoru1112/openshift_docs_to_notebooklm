...
# 対象のOpenShiftドキュメントバージョン
BASE_URL = "https://docs.redhat.com/en/documentation/openshift_container_platform/4.18"
...
def get_single_page_links(base_url):
    ...
    for link in links:
        ...
        if href and href.startswith("/en/documentation/openshift_container_platform/4.18/html/"):
...
def add_urls_to_notebooklm(notebook_url, urls_to_add):
...
if __name__ == "__main__":
    ...
    # NotebookLMにURLを追加
    add_urls_to_notebooklm(notebook_url, urls)
